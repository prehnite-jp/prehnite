#![doc = "バンドル済みフォントのライセンスバンドル"]
use crate::license_bundle::{LicenseBundle, Package};

/// バンドル済みフォントのライセンスバンドルを定義します。
pub fn font() -> LicenseBundle {
    ...
    license.push(
        Package::new("Material Symbols Outlined", "Apache-2.0")
            ...
            .license_text(
                include_str!("../../../assets/fonts/Material_Symbols_Outlined/LICENSE.txt")
                    .to_string(),
            ),
    );
    license.push(
        Package::new("Noto Sans", "OFL-1.1")
            ...
            .license_text(include_str!("../../../assets/fonts/Noto_Sans/OFL.txt").to_string()),
    );
    license.push(
        Package::new("Sawarabi Gothic", "OFL-1.1")
            .homepage("https://fonts.google.com/specimen/Sawarabi+Gothic")
            .license_text(
                include_str!("../../../assets/fonts/Sawarabi_Gothic/OFL.txt").to_string(),
            ),
    );
    license
}
