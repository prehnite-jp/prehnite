...
impl BackgroundInfo {
    async fn load_all(&mut self, conn: &mut SqliteConnection) -> Result<(), sqlx::Error> {
        self.load_references(conn).await
    }
}

impl Bibliography {
    pub async fn load_authors(&mut self, conn: &mut SqliteConnection) -> Result<(), sqlx::Error> {
...
impl Item {
    ...
    pub async fn load_tags(&mut self, conn: &mut SqliteConnection) -> Result<(), sqlx::Error> {
    ...
    pub async fn load_tasks(&mut self, conn: &mut SqliteConnection) -> Result<(), sqlx::Error> {
...
impl Headline {
    pub async fn load_paragraph(&mut self, conn: &mut SqliteConnection) -> Result<(), sqlx::Error> {
...
impl Paragraph {
    pub async fn load_draft(&mut self, conn: &mut SqliteConnection) -> Result<(), sqlx::Error> {
        self.draft = Some(query::fetch_paragraph_related_draft(conn, self.id).await?);
        Ok(())
    }

    pub async fn load_summary(&mut self, conn: &mut SqliteConnection) -> Result<(), sqlx::Error> {
