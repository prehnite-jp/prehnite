...
SELECT paragraph.*,
       ...
       draft.prev_draft_id        AS d_prev_draft_id,
       draft.next_draft_id        AS d_next_draft_id,
...
SELECT items.*,
       ...
       view_deserializable_paragraph.prev_paragraph_id AS p_prev_paragraph_id,
       view_deserializable_paragraph.next_paragraph_id AS p_next_paragraph_id,
       ...
       view_deserializable_paragraph.d_prev_draft_id,
       view_deserializable_paragraph.d_next_draft_id,
...
SELECT paragraph_link.*,
       ...
       from_p.prev_paragraph_id         AS from_p_prev_paragraph_id,
       from_p.next_paragraph_id         AS from_p_next_paragraph_id,
       ...
       from_p.h_prev_headline_id        AS from_h_prev_headline_id,
       from_p.h_next_headline_id        AS from_h_next_headline_id,
       from_p.d_id                      AS from_d_id,
       from_p.d_paragraph_id            AS from_d_paragraph_id,
       from_p.d_prev_draft_id           AS from_d_prev_draft_id,
       from_p.d_next_draft_id           AS from_d_next_draft_id,
       ...
       to_p.prev_paragraph_id           AS to_p_prev_paragraph_id,
       to_p.next_paragraph_id           AS to_p_next_paragraph_id,
       ...
       to_p.h_prev_headline_id          AS to_h_prev_headline_id,
       to_p.h_next_headline_id          AS to_h_next_headline_id,
       to_p.d_id                        AS to_d_id,
       to_p.d_paragraph_id              AS to_d_paragraph_id,
       to_p.d_prev_draft_id             AS to_d_prev_draft_id,
       to_p.d_next_draft_id             AS to_d_next_draft_id,
       ...
       t.prev_task_id                   AS t_prev_task_id,
       t.next_task_id                   AS t_next_task_id,
       t.tc_id                          AS tc_id,
